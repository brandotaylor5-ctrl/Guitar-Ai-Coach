...
export const PATH: PathStep[] = [
  ...
  },
  {
    ...
    title: 'A and E',
    kind: 'chord',
    outcome: 'Add the two chords that open the blues and most rock.',
    why: 'G, C and D gets you folk and country. A, D and E gets you blues and rock, and those three keys cover most of what anyone plays.',
    steps: [
      'A: index, middle and ring fingers all on the 2nd fret, on the D, G and B strings. Play five strings, not the low E.',
      'Squeeze all three fingers together and keep them arched so the thin E string still rings.',
      'E: middle on the 2nd fret of the A string, ring on the 2nd fret of the D string, index on the 1st fret of the G string. All six strings.',
      'E is E minor with one extra finger — put your index on the G string at fret one.',
      'Practise A to E and back. It is the most common change in blues.',
    ],
    check: 'Both ring cleanly and you can change between them without a gap.',
    watchFor: 'On A, three fingers in one fret is crowded. Come up on the tips; if the thin E is dead, that is why.',
    expect: 'A week or two. A is more awkward than it looks.',
    chords: ['A', 'E'],
    practice: { view: 'lessons', params: { skill: 'chord.A', path: 'chord-a-e' }, label: 'Start by learning A cleanly' },
  },
  {
    id: 'boom-chuck',
  ...
  },
  {
    ...
    kind: 'technique',
    outcome: 'Sound a note without picking it.',
    why: 'This is how guitarists play more notes than their picking hand could manage, and it is most of what makes a line sound fluid instead of typed out.',
    steps: [
      'Pick the open G string and let it ring.',
      'While it is still sounding, hammer your finger down hard onto the 2nd fret. The note changes without a new pick.',
      'Now the reverse: fret the 2nd fret, pick it, then pull your finger off sideways so the open string rings.',
      'Pull off sideways, not straight up — the sideways flick is what sounds the string.',
      'Do both in a row: pick, hammer, pull off. One pick, three notes.',
    ],
    check: 'The hammered and pulled notes are as loud as the picked one.',
    watchFor: 'A weak hammer. It needs to be a genuine hit, from the knuckle, not a press.',
    expect: 'A day to get a sound, a couple of weeks to make them even.',
    practice: { view: 'session', label: 'Play them and let the app watch' },
  },
  {
    id: 'scale-minor-pent',
  ...
  },
  {
    ...
    practice: { view: 'lessons', label: 'Learn the shape and hear the licks' },
  },
  {
    id: 'bend',
    title: 'Bend a note',
  ...
  },
  {
    ...
    chord: 'F',
    practice: { view: 'session', label: 'Strum it and I will check each string' },
  },
  {
    id: 'power-chords',
    title: 'Power chords',
  ...
  },
  {
    ...
    chord: 'Em',
    practice: { view: 'session', label: 'Play it and let the app listen' },
  },
  {
    id: 'dynamics',
